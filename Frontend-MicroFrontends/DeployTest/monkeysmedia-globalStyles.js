  ...
  \*****************************/
                /***/ (
                  ...
                  if (theme) {
                    theme =
                      String(
                        Object.keys(theme).sort(function (a, b) {
                          return a.localeCompare(b);
                        })
                      ) ===
                      String(
                        ["primary", "secundary", "white", "card", "red"].sort(
                          function (a, b) {
                            return a.localeCompare(b);
                          }
                        )
                  ...
                  styled_components__WEBPACK_IMPORTED_MODULE_1__.createGlobalStyle)(
                    ...
                    !theme ? defaultTheme.primary : theme.primary,
                    !theme ? defaultTheme.secundary : theme.secundary,
                    !theme ? defaultTheme.card : theme.card,
                    !theme ? defaultTheme.white : theme.white,
                    !theme ? defaultTheme.red : theme.red
                  );
                ...
                /***/ (
                  ...
                  function Root(props) {
                    return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.default.createElement(
                      _globalStyles__WEBPACK_IMPORTED_MODULE_1__.default,
                      null
                    );
                  }
