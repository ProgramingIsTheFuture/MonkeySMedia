          ...
          (() => {
            ...
            return (
              ...
              (() => {
                ...
                function N(e, t, n) {
                  ...
                  if ("route" === e.nodeName.toLowerCase()) {
                    var i = { type: "route", routes: [] },
                      u = E(e, "path");
                    u && (i.path = u),
                      O(e, "default") && (i.default = !0),
                      O(e, "exact") && (i.exact = !0),
                      S(e, i, t);
                    for (var s = 0; s < e.childNodes.length; s++) {
                      var p;
                      (p = i.routes).push.apply(p, c(N(e.childNodes[s], t, n)));
                    }
                    return [i];
                  }
                  ...
                  if (e.childNodes) {
                    for (
                      ...
                      var v;
                      (v = m.routes).push.apply(v, c(N(e.childNodes[h], t, n)));
                    }
                    return [m];
                  }
                ...
                function W(t) {
                  return t === e.SKIP_BECAUSE_BROKEN || t === e.LOAD_ERROR;
                }
                function I(e) {
                  var t =
                ...
                var k,
                    ...
                    return (
                      (function (e) {
                        ...
                        if (
                          ...
                          e.redirects)) {
                            var o = e.redirects[r];
                            h("routesConfig.redirects key", r),
                              h("routesConfig.redirects['".concat(r, "']"), o);
                          }
                      ...
                      loadApp: function (t) {
                        ...
                        return (
                          localStorage.getItem("auth") ||
                            ("@monkeysmedia/login" != n &&
                              "@monkeysmedia/register" != n &&
                              "@monkeysmedia/not-found" != n &&
                              "@monkeysmedia/globalStyles" != n &&
                              "@monkeysmedia/notifications" != n &&
                              (0, e.navigateToUrl)("/login/")),
                          System.import(n)
                        );
                      },
                    }).routes),
                  ...
                  U = (function (n) {
                    var r = n.routes,
                      ...
                      i = !1,
                      c = {},
                      u = r.base.slice(0, r.base.length - 1),
                      s = {
                        isActive: function () {
                          return i;
                        },
                    ...
                    function p(t) {
                      ...
                      if (n && n.error) {
                        var o = document.getElementById(j(n.name)),
                          a = "string" == typeof n.error ? A(n.error) : n.error;
                    ...
                    function d(n) {
                      ...
                      for (var p in r.redirects) {
                        var d = l(p);
                        if ("object" === t(d)) return d.v;
                      }
                      for (var f in a)
                        c[f] &&
                          W((0, e.getAppStatus)(f)) &&
                          !W(a[f]) &&
                          (c[f].unmount(), delete c[f]);
                    }
                    function f() {
                      if (0 === I(r).indexOf(u)) {
                        var t =
                          ...
                          n = (0, e.getMountedApps)().reduce(function (e, t) {
                            return (e[t] = document.getElementById(j(t))), e;
                          }, {});
                        P({
                          location: window.location,
                          routes: r.routes,
                    ...
                    function m(t) {
                      var n = t.detail.newUrl,
                        r = [],
                        o = (0, e.checkActivityFunctions)(n ? T(n) : location);
                      (0, e.getAppNames)().forEach(function (e) {
                        o.indexOf(e) < 0 && r.push(e);
                      }),
                        r.forEach(function (e) {
                          c[e] && (c[e].unmount(), delete c[e]);
                          var t = document.getElementById(j(e));
                          t && t.isConnected && t.parentNode.removeChild(t);
                        });
                    }
                  })({ routes: H, applications: B });
...
//# sourceMappingURL=monkeysmedia-root-config.js.map
