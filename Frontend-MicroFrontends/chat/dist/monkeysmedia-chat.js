...
/* harmony export */   "SendDimensions": () => (/* binding */ SendDimensions)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/extends */ "./node_modules/@styled-icons/fluentui-system-regular/node_modules/@babel/runtime/helpers/esm/extends.js");
...
var Send = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.forwardRef(function (props, ref) {
  var attrs = {
    "fill": "currentColor",
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(_styled_icons_styled_icon__WEBPACK_IMPORTED_MODULE_2__.StyledIconBase, (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__.default)({
    ...
    d: "m3.79 2.77 21.07 10.08a1.25 1.25 0 0 1 0 2.26L3.8 25.18a1.25 1.25 0 0 1-1.75-1.45l2.66-9.75-2.66-9.75A1.25 1.25 0 0 1 3.8 2.77zm-.15 1.6 2.42 8.88H17c.38 0 .7.28.74.65l.01.1c0 .38-.28.7-.65.74l-.1.01H6.05l-2.41 8.84 20.1-9.61-20.1-9.62z"
  }));
});
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var _styles__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./styles */ "./src/HeaderProfile/styles.ts");
...
var HeaderProfile = function HeaderProfile(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.default.createElement(_styles__WEBPACK_IMPORTED_MODULE_2__.Container, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.default.createElement("div", {
    style: {
      cursor: "pointer"
    },
    onClick: function onClick() {
      return System["import"]("@monkeysmedia/util-module").then(function (util) {
        return util.RedirectTo("/profile/".concat(data.user));
      });
    }
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.default.createElement("div", null, baseUrl ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.default.createElement("img", {
    src: "".concat(baseUrl).concat(data.profile_image.substring(1)),
    alt: "profile",
    height: "50px",
    width: "50px"
  }) : baseUrl), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.default.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.default.createElement("div", {
    style: {
      alignItems: "center"
    }
  }, data.user))));
...
var Container = styled_components__WEBPACK_IMPORTED_MODULE_1__.default.header(_templateObject || (_templateObject = (0,_babel_runtime_helpers_esm_taggedTemplateLiteral__WEBPACK_IMPORTED_MODULE_0__.default)(["\n  height: 65px;\n  z-index: 1;\n\n  background-color: var(--secundary);\n  order: 0;\n\n  top: 0;\n\n  h3 {\n\ttext-align: center;\n\tcolor: var(--white);\n  }\n}\n\n  div {\n    display: flex;\n    height: 100%;\n\n    flex-direction: row;\n\tmargin-left: 5px;\n\n    color: var(--white);\n\n    text-decoration: none;\n\talign-items: center;\n\n    div {\n      img {\n\t\tborder-radius: 25px;\n        object-fit: cover;\n        margin-right: 15px;\n      }\n    }\n  }\n"])));
...
/* harmony import */ var _HeaderProfile__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./HeaderProfile */ "./src/HeaderProfile/index.tsx");
...
function Root(props) {
  ...
  window.addEventListener("@monkeysmedia/chat/changeChat", function (e) {
    setSendToUser(e.detail.user);
    setReloadMsg(true);
  });
  var me = (0,swr__WEBPACK_IMPORTED_MODULE_4__.default)("api/users/get-user/", function (url) {
    return System["import"]("@monkeysmedia/util-module").then(function (util) {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_2__.useEffect)(function () {
    if (allMessages.length >= 0) {
      document.getElementById("_scrolling").scrollTop = document.getElementById("_scrolling").scrollHeight;
    }
  }, [allMessages, sendToUser]);
  (0,react__WEBPACK_IMPORTED_MODULE_2__.useEffect)(function () {
    if (sendToUser !== "" && socketUrl !== "") {
      var token = localStorage.getItem("auth");
      var wsUrl = "".concat(socketUrl, "ws/chat/").concat(sendToUser, "/?token=").concat(JSON.parse(token).token);
  ...
  var handleSubmit = function handleSubmit(e) {
    ...
    if (message !== "") {
      ...
      socket.send(message);
      setAllMessages([].concat((0,_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__.default)(allMessages), [{
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2__.default.createElement(_styles__WEBPACK_IMPORTED_MODULE_3__.Container, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2__.default.createElement(_HeaderProfile__WEBPACK_IMPORTED_MODULE_5__.default, {
    username: sendToUser
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2__.default.createElement(_styles__WEBPACK_IMPORTED_MODULE_3__.Messages, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2__.default.createElement(_styles__WEBPACK_IMPORTED_MODULE_3__.MessageContainer, {
    id: "_scrolling"
  }, allMessages.map(function (item) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2__.default.createElement(_styles__WEBPACK_IMPORTED_MODULE_3__.Message, {
    ...
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2__.default.createElement("span", null, item.message))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2__.default.createElement(_styles__WEBPACK_IMPORTED_MODULE_3__.TimeStamp, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2__.default.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2__.default.createElement("span", null, item.timestamp)))));
  }))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2__.default.createElement("footer", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2__.default.createElement(_styles__WEBPACK_IMPORTED_MODULE_3__.Form, {
    ...
    value: message
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2__.default.createElement(_styles__WEBPACK_IMPORTED_MODULE_3__.SubmitBTN, {
    type: "submit",
    disabled: message === "" ? true : false
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2__.default.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2__.default.createElement(_styles__WEBPACK_IMPORTED_MODULE_3__.SendIcon, null))))));
}
...
/* harmony import */ var _babel_runtime_helpers_esm_taggedTemplateLiteral__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/esm/taggedTemplateLiteral */ "./node_modules/@babel/runtime/helpers/esm/taggedTemplateLiteral.js");
/* harmony import */ var styled_components__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! styled-components */ "../node_modules/styled-components/dist/styled-components.browser.esm.js");
/* harmony import */ var _styled_icons_fluentui_system_regular__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @styled-icons/fluentui-system-regular */ "./node_modules/@styled-icons/fluentui-system-regular/Send/Send.esm.js");
...
var Messages = styled_components__WEBPACK_IMPORTED_MODULE_1__.default.div(_templateObject2 || (_templateObject2 = (0,_babel_runtime_helpers_esm_taggedTemplateLiteral__WEBPACK_IMPORTED_MODULE_0__.default)(["\n  position: relative;\n  z-index: 1;\n\n  flex: 1 1 0;\n  order: 2;\n\n  width: 100%;\n  height: 100%;\n"])));
var MessageContainer = styled_components__WEBPACK_IMPORTED_MODULE_1__.default.div(_templateObject3 || (_templateObject3 = (0,_babel_runtime_helpers_esm_taggedTemplateLiteral__WEBPACK_IMPORTED_MODULE_0__.default)(["\n  position: absolute;\n  top: 0;\n  z-index: 100;\n  box-sizing: border-box;\n  display: flex;\n  flex-direction: column;\n  width: 100%;\n  height: 100%;\n  overflow-x: hidden;\n  overflow-y: scroll;\n  transition: background 0.3s ease-out 0.1s;\n"])));
var Message = styled_components__WEBPACK_IMPORTED_MODULE_1__.default.div(_templateObject4 || (_templateObject4 = (0,_babel_runtime_helpers_esm_taggedTemplateLiteral__WEBPACK_IMPORTED_MODULE_0__.default)(["\n  display: flex;\n  justify-content: ", ";\n\n  padding: 6px 7px 8px 9px;\n\n  div {\n    margin: 0;\n    background-color: ", ";\n\n    color: var(--white);\n  }\n"])), function (props) {
  return props.right ? "flex-end" : "flex-start";
}, function (props) {
  return !props.right ? "var(--card)" : "var(--secundary)";
});
var TimeStamp = styled_components__WEBPACK_IMPORTED_MODULE_1__.default.div(_templateObject5 || (_templateObject5 = (0,_babel_runtime_helpers_esm_taggedTemplateLiteral__WEBPACK_IMPORTED_MODULE_0__.default)(["\n  float: right;\n\n  span {\n    font-size: 1rem;\n  }\n"])));
var Form = styled_components__WEBPACK_IMPORTED_MODULE_1__.default.form(_templateObject6 || (_templateObject6 = (0,_babel_runtime_helpers_esm_taggedTemplateLiteral__WEBPACK_IMPORTED_MODULE_0__.default)(["\n  display: flex;\n  justify-content: center;\n  align-items: center;\n\n  input[type=\"text\"] {\n    width: 88%;\n    height: 48px;\n  }\n"])));
var SubmitBTN = styled_components__WEBPACK_IMPORTED_MODULE_1__.default.button(_templateObject7 || (_templateObject7 = (0,_babel_runtime_helpers_esm_taggedTemplateLiteral__WEBPACK_IMPORTED_MODULE_0__.default)(["\n  height: 54px;\n  width: 54px;\n\n  margin: 10px;\n  border-radius: 25px;\n\n  cursor: pointer;\n\n  div {\n    position: relative;\n  }\n"])));
var SendIcon = (0,styled_components__WEBPACK_IMPORTED_MODULE_1__.default)(_styled_icons_fluentui_system_regular__WEBPACK_IMPORTED_MODULE_2__.Send)(_templateObject8 || (_templateObject8 = (0,_babel_runtime_helpers_esm_taggedTemplateLiteral__WEBPACK_IMPORTED_MODULE_0__.default)(["\n  height: 40px;\n  width: 40px;\n\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n"])));
